...
def _(name: str, **kwargs):
    match name.lower():
        case "random":
            from bayesflow.experimental.networks.coupling_flow.permutations import RandomPermutation
            return RandomPermutation(**kwargs)
        case "swap":
            from bayesflow.experimental.networks.coupling_flow.permutations import Swap
            return Swap(**kwargs)
        case "learnable" | "orthogonal":
            from bayesflow.experimental.networks.coupling_flow.permutations import OrthogonalPermutation
