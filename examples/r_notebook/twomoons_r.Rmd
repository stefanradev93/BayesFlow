...
sample_data <- simulator$sample(r_to_py(c(128L))) # notice here we need to specify 128 as an integer
```
...
# data_adapter$data_adapters[["inference_variables"]] <- "theta"
# data_adapter$data_adapters[["inference_conditions"]] <- "x"
```
